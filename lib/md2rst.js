...
/**
* FUNCTION: convert()
*	Returns a function for converting Markdown data to reStructuredText.
*
* @returns {Function} function for converting Markdown data to reStructuredText
*/
function convert() {
	/**
	...
	* @returns {Void}
	*/
	return function convert( data, clbk ) {
		var count;
		var keys;
		var opts;
		var rst;
